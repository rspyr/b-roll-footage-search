          ...
          {!q ? (
            ...
            <>
              <div className="text-sm text-muted-foreground">
                Found {searchData?.total || 0} results for "{q}"
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {searchData?.results.map((result, i) => (
                  <div 
                    ...
                    onClick={() => setLocation(`/videos/${result.videoId}?t=${result.timestampSec}`)}
                  >
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      <div className="mt-4 flex items-center text-xs font-medium text-muted-foreground hover:text-primary transition-colors group">
